module.exports.config = {
  ...
  module.exports.handleEvent = async function({ api, args, Users, event, Currencies, Threads
}) {
  ...
  if(indexOf("xin lỗi vk iu") || indexOf("xin lỗi vk yêu") || indexOf("xin lỗi chồng yêu") || indexOf("xin lỗi chồng iu")) {
