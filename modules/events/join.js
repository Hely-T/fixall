...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		try {
			...
			(typeof threadData.customJoin == "undefined") ? msg = "Chào mừng súc vật {name} đã đến với {threadName}.\nMày là súc sinh thứ {soThanhVien} Hãy tương tác nhiều để đầu thai thành người 🥳♥" : msg = threadData.customJoin;
			msg = msg
